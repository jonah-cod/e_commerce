...
function createProduct(product){
  ...
  // creating product children elements
  ...
  productPriceEle.innerText = `Price: Ksh${product.price}` // "price: " + product.price

  //appending all children elements to product div
  productElement.append(productImgEle, productTitleELe, productPriceEle);
  return productElement;
}

for(let i=0; i<products.length; i++){
  productsEleList.push(createProduct(products[i]))
}
//append the created products html elements to the DOM
productsContainer.append(...productsEleList)


//Display product details functionality

let productPopup = document.getElementById("popup");
let preventClick = document.getElementById("prevent")
//all product elements
let productsEle = document.querySelectorAll(".product");

//add event listener to all products 
for (let i = 0; i < productsEle.length; i++) {
  productsEle[i].addEventListener("click", (e)=>{
...
productPopup.innerHTML = productPopupDetails;
